      ...
      <Dialog open={!!post} onOpenChange={(open) => !open && onClose()}>
        <DialogContent className="max-w-[100vw] w-[100vw] h-[100vh] max-h-[100vh] p-0 overflow-hidden bg-transparent border-0 rounded-none [&>button]:hidden">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <div
              className="relative z-10 w-full h-full overflow-y-auto overflow-x-hidden cursor-zoom-in"
            ...
            >
              ...
              {/* Zoom hint - positioned fixed within scroll container */}
              <div className="sticky bottom-20 left-1/2 -translate-x-1/2 w-fit mx-auto flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/50 text-white/80 text-sm opacity-0 hover:opacity-100 transition-opacity pointer-events-none">
